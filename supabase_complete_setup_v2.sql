-- ===== COMPLETE SUPABASE SETUP v2 WITH ALL TABLES AND DATA =====
-- Copy and paste this ENTIRE script into Supabase SQL Editor
-- This creates: facilities, users, patients, and appointments
...
-- ===== INSERT SAMPLE USERS =====
INSERT INTO public.users (email, password, facility_name, facility_id, user_role, is_active)
VALUES
  ('demo@facility.com', 'Demo123!', 'Demo Facility', 'facility-kampala-001', 'Administrator', true),
  ('admin@kampala.ug', 'Password123!', 'Kampala Medical Centre', 'facility-kampala-001', 'Administrator', true),
  ('manager@mbarara.ug', 'Password123!', 'Mbarara Regional Hospital', 'facility-mbarara-001', 'Manager', true),
  ('director@jinja.ug', 'Password123!', 'Jinja District Hospital', 'facility-jinja-001', 'Administrator', true);
...
FROM (
  SELECT 'PAT1001' as patient_id, 'James' as first_name, 'Okoro' as last_name, 42 as age, 'M' as gender, '256712345678' as phone_number, 'james.okoro@email.com' as email, 'HIV' as primary_condition, 'Kampala' as region, 'Kampala Regional Referral Hospital' as facility, 'facility-kampala-001' as facility_id_code, 'Active' as status, '2023-01-15'::DATE as registered_date, '95%' as art_adherence_percent, 'Undetectable' as viral_load_status
  ...
  UNION ALL SELECT 'PAT1012', 'Linda', 'Nyerere', 36, 'F', '256718234567', 'linda.nyerere@email.com', 'Mixed (HIV+Diabetes)', 'Arua', 'Arua Health Center III', 'facility-arua-001', 'Active', '2023-03-20'::DATE, '81%', 'Moderate'
  UNION ALL SELECT 'PAT1013', 'Charles', 'Mandela', 52, 'M', '256703456789', 'charles.mandela@email.com', 'HIV', 'Masaka', 'Masaka District Hospital', 'facility-masaka-001', 'Active', '2023-01-05'::DATE, '96%', 'Undetectable'
  UNION ALL SELECT 'PAT1014', 'Alice', 'Dlamini', 39, 'F', '256719456789', 'alice.dlamini@email.com', 'Asthma', 'Soroti', 'Soroti Regional Referral Hospital', 'facility-soroti-001', 'Active', '2023-02-10'::DATE, 'N/A', 'N/A'
  ...
  UNION ALL SELECT 'PAT1016', 'Jane', 'Obi', 31, 'F', '256715678901', 'jane.obi@email.com', 'HIV', 'Fort Portal', 'Fort Portal Regional Referral Hospital', 'facility-fortportal-001', 'Active', '2023-01-18'::DATE, '89%', 'Low'
  UNION ALL SELECT 'PAT1017', 'Paul', 'Senghor', 56, 'M', '256708901234', 'paul.senghor@email.com', 'Hypertension', 'Mbarara', 'Mbarara Regional Referral Hospital', 'facility-mbarara-001', 'Active', '2023-02-22'::DATE, 'N/A', 'N/A'
  UNION ALL SELECT 'PAT1018', 'Elizabeth', 'Kenyatta', 42, 'F', '256716234567', 'elizabeth.kenyatta@email.com', 'Diabetes', 'Jinja', 'Jinja Regional Referral Hospital', 'facility-jinja-001', 'Active', '2023-03-08'::DATE, 'N/A', 'N/A'
  UNION ALL SELECT 'PAT1019', 'Joseph', 'Habyarimana', 48, 'M', '256707123456', 'joseph.habyarimana@email.com', 'Mixed (HIV+Diabetes)', 'Arua', 'Arua Regional Referral Hospital', 'facility-arua-001', 'Active', '2023-01-28'::DATE, '94%', 'Undetectable'
  UNION ALL SELECT 'PAT1020', 'Margaret', 'Chiluba', 37, 'F', '256720123456', 'margaret.chiluba@email.com', 'HIV', 'Masaka', 'Masaka District Hospital', 'facility-masaka-001', 'Active', '2023-02-16'::DATE, '85%', 'Low'
) AS patient_data
